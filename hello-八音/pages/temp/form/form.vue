<template>
	<view>
		<cu-custom bgColor="by-bg-white" :isBack="true">
		...
		<form>
			...
			<view class="cu-form-group">
				...
				<input placeholder="普通文本" name="input"></input>
			</view>
			<!-- 带图标输入框 -->
			<view class="cu-form-group">
				<view class="title">带图标</view>
				<input placeholder="输入框带个图标" name="input"></input>
				<text class='iconfont icon-brush by-text-red'></text>
			</view>
			<!-- 带按钮输入框 -->
			<view class="cu-form-group">
				<view class="title">验证码</view>
				<input placeholder="输入框带个按钮" name="input"></input>
				<button class='cu-btn by-bg-green by-text-white'>验证码</button>
			</view>
			<!-- 数字输入 -->
			<view class="cu-form-group">
				<view class="title">手机号码</view>
				<input placeholder="数字输入" type="number" name="input"></input>
			</view>
			<!-- 普通单列选择 -->
			...
			<view class="cu-form-group margin-top">
				...
				<switch class="by-green" @change="SwitchA" :class="switchA?'checked':''" :checked="switchA?true:false"></switch>
			</view>
			<!-- 方形开关 -->
			<view class="cu-form-group">
				<view class="title">方形开关</view>
				<switch class="by-green radius" @change="SwitchD" :class="switchD?'checked':''" :checked="switchD?true:false"></switch>
			</view>
			<radio-group class="block" @change="RadioChange">
				<view class="cu-form-group margin-top">
					<view class="title">默认单选</view>
				...
				<view class="cu-form-group">
					<view class="title">等比缩小，横排</view>
					<view class="flex">
						<view class="flex" style="align-items: center;">
							<radio style="transform: scale(0.7);" class='radio margin-left-sm' :class="radio=='C'?'checked':''"
							 :checked="radio=='C'?true:false" value="C"></radio>
							<text>男</text>
						</view>
						<view class="flex" style="align-items: center;">
							<radio style="transform: scale(0.7);" class='radio margin-left-sm' :class="radio=='D'?'checked':''" :checked="radio=='D'?true:false"
							 value="D"></radio>
							<text>女</text>
						</view>
					</view>
				...
				<view class="cu-form-group">
					...
					<view class="flex">
						<view class="flex" style="align-items: center;">
							<radio style="transform: scale(0.7);" class='red margin-left-sm' :class="radio=='C'?'checked':''"
							 :checked="radio=='C'?true:false" value="C"></radio>
							<text>男</text>
						</view>
						<view class="flex" style="align-items: center;">
							<radio style="transform: scale(0.7);" class='green margin-left-sm' :class="radio=='D'?'checked':''" :checked="radio=='D'?true:false"
							 value="D"></radio>
							<text>女</text>
						</view>
					</view>
